...
<v-container fluid pt-2 px-0>
    <v-layout class="visit-text" grid-list-xl v-for="text in texts" :key="text.id" align-center>
    <v-flex pt-4 class="image" xs4 v-bind:class="text.class"  :id="text.cigaretes" data-aos="fade-up" data-aos-duration="1000">
    ...
    <v-flex xs5 justify-start class="offset-xs1"  data-aos="fade-up" data-aos-duration="2500">
            ...
            <div class="line"></div>
            <p v-html="text.content" class="body-1"></p>
    </v-flex > 
    </v-layout>
